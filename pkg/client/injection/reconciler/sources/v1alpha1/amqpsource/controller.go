...
import (
	...
	versionedscheme "github.com/Markus-Schwer/eventing-amqp/pkg/client/clientset/versioned/scheme"
	client "github.com/Markus-Schwer/eventing-amqp/pkg/client/injection/client"
	amqpsource "github.com/Markus-Schwer/eventing-amqp/pkg/client/injection/informers/sources/v1alpha1/amqpsource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "amqpsource-controller"
	defaultFinalizerName       = "amqpsources.sources.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	amqpsourceInformer := amqpsource.Get(ctx)

	lister := amqpsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.AmqpSource"),
	)
