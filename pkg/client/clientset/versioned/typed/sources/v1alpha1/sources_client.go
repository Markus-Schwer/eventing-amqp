...
import (
	...
	"github.com/Markus-Schwer/eventing-amqp/pkg/client/clientset/versioned/scheme"
...
func (c *SourcesV1alpha1Client) AmqpSources(namespace string) AmqpSourceInterface {
	return newAmqpSources(c, namespace)
}
